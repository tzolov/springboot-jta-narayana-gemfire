 ...
 */
public class NarayanaLrcoSupport {
     ...
     * <p>
     * <p>
     * Failure to enlist will throw an {@link NarayanaLrcoException} runtime exception, rolling back the transaction.
     */
    public static void enlistGeodeAsLastCommitResource() {
        ...
        try {
            ...
            throw new NarayanaLrcoException("Failed to obtain the running transaction", e);
        } catch (RollbackException e) {
            throw new NarayanaLrcoException("Failed to enlist Geode as LRCO resource in the transaction!", e);
        }
    }
}
